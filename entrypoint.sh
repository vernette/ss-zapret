...
sync_defaults "/opt/zapret/init.d/custom.d.examples.linux.dist" "/opt/zapret/init.d/custom.d.examples.linux" "custom.d script"

/opt/zapret/init.d/sysv/zapret start

cleanup() {
  /opt/zapret/init.d/sysv/zapret stop || true
